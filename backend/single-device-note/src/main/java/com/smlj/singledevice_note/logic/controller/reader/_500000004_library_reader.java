...
@Slf4j
public class _500000004_library_reader extends AnalysisEventListener<Tcggy_library_500000004> {
    /*private int BATCH_COUNT = 1000;*/
    public List<Tcggy_library_500000004> arr = new ArrayList<>();

    public _500000004_library_reader(List<Tcggy_library_500000004> arr) {
        this.arr = arr;
    }
