package com.smlj.lpjtlj.logic.o.vo.table.dao;

import com.mongodb.client.result.DeleteResult;
import com.smlj.lpjtlj.logic.controller.lp.EPtype;
import com.smlj.lpjtlj.logic.o.vo.table.entity.lp.*;
import lombok.Data;
...
public class TlpDao {
    ...
    private List<String> _getPs(String id) {
        var cfg = mongoTemplate.findById(id, TlpPCfg.class, P_COLLECTION_NAME);
