...
public class Result<T> extends Message<T> {
    ...
    public static <T> Result<T> success(T data) {
        return success(data, ResultCode.RC1.getMessage());
    }

    public static <T> Result<T> success(T data, String message) {
        return new Result<>(ResultCode.RC1.getCode(), data, message);
    }
    ...
    public static <T> Result<T> fail(String message, T data) {
        return fail(ResultCode.RC400.getCode(), message, data);
    }
    ...
    public static boolean isSuccess(int code) {
        return Objects.equals(code, ResultCode.RC1.getCode());
    }
}
