...
import com.smlj.singledevice_note.logic.o.vo.table.entity.TDevice;
...
public interface TDeviceDao {
    ...
    ArrayList<TDevice> doSelectSimple(@Param("tableName") String tableName, @Param("select") String select, @Param("conds") String conds, @Param("orderBys") String orderBys);
}
