...
const DEVICE_RECORD_PAGE_SIZE = 11
const PAPER_COUNT = 8
...
function resetDeviceRecordInfo() {
...
<template>
    <div>
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                background-color: #1C4785;  overflow-y: auto;">
                    ...
                    <el-menu style="overflow-y: hidden; margin-left: -15px"
                ...
                <div v-loading="loadingDeviceList" v-if="curGYId !== -1"
                     style="width: 570px; padding-left: 0;">
                    <!--https://element-plus.org/zh-CN/component/table.html#%E7%AD%9B%E9%80%89-->
                    <el-table :data="deviceList" fit stripe border highlight-current-row @current-change="onDeviceClicked"
                              style="width: 100%">
                ...
                <div v-loading="loadingDeviceRecordList" v-if="curDeviceId !== -1"
                    ...
                    <el-button-group style="width: 100%;">
                        <el-button style="font-size: 15px; width: 100%; height: 40px"
                                   @click="onAddDeviceRecordClicked">+
                        </el-button>
                    </el-button-group>
                    <div v-if="deviceRecordTotal > 0">
                        <el-table :data="deviceRecordList" fit stripe border highlight-current-row
                                  style="width: 100%; margin-top: 20px">
                            <el-table-column sortable prop="id" label="id" width="70"/>
                            <el-table-column sortable prop="c_person" label="检修人" width="180"/>
                            ...
                            <el-table-column prop="c_trouble_xx" label="故障现象" width="180"/>
        ...
        <el-dialog v-model="showDialogue" title="检修记录" width="600" draggable modal>
